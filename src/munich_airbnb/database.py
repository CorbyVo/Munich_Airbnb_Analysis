...
def save_cleaned_listings_snapshot(
    ...
    print("Latest table: cleaned_listings_latest")
    print("History table: cleaned_listings_history")
...
def save_csv_outputs_to_sqlite(
    ...
    cleaned_listing_candidates = [
        results_dir / "tableau_budget_location_listings.csv",
        results_dir / "tableau_listings.csv",
    ]

    cleaned_listing_path = None

    for candidate_path in cleaned_listing_candidates:
        if candidate_path.exists():
            cleaned_listing_path = candidate_path
            break

    if cleaned_listing_path is None:
